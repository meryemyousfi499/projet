...
export default function ApplicationsReviewPage() {
  ...
  // ✅ L152 — Ternaire imbriqué extrait
  const renderContent = () => {
    if (loading) {
  ...
  // ✅ L178 — Ternaire imbriqué extrait
  const renderModalFooterBtn = () => {
    if (processing) {
      return <><span className="btn-spinner"></span>Traitement...</>;
    }
    if (action === 'accepté') {
      return "Confirmer l'acceptation";
    }
    return 'Confirmer le refus';
  };
  ...
  return (
    <div>
      ...
      {/* ✅ L152 — Ternaire imbriqué remplacé par fonction */}
      {renderContent()}
        ...
        <div className="modal-overlay" onClick={() => setReviewModal(null)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              ...
              {/* ✅ L178 — Ternaire imbriqué remplacé par fonction */}

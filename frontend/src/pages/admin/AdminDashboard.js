...
import StatsGrid from '../../components/common/StatsGrid'; // ✅ ajouter
import { useNavigate } from 'react-router-dom';
import { FiUsers, FiBriefcase, FiClock, FiCheckCircle, FiAlertCircle, FiAward } from 'react-icons/fi';
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20, marginBottom: 24 }}>
        ...
        <div className="card">
          ...
          {data.projectsByDept?.length === 0 ? (
            ...
            <div>
              {data.projectsByDept?.map((d) => (
                <div key={d._id || d.label} style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
